...
#refresh .m .fore4 a {
	...
	font-size: 12px
			...
			<span class="txt">您已经退出登录了...</span>
			<ul class="m">
				<li class="fore1">您可以：返回淘淘首页或者重新登录
				</li>
				<li class="fore2"><a href="http://localhost:8082" target="_blank">淘淘首页</a></li>
				<li class="fore3"><a href="http://localhost:8088/page/login" target="_blank">重新登录</a></li>
			</ul>
		</div>
	</div>
